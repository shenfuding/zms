...
wget ${DOWNLOAD_LIB_URL}/${ROCKETMQ_FILE_NAME} -O "${ZMS_TEM_DIR}/${ROCKETMQ_FILE_NAME}"
wget ${DOWNLOAD_LIB_URL}/${KAFKA_FILE_NAME} -O "${ZMS_TEM_DIR}/${KAFKA_FILE_NAME}"
wget ${DOWNLOAD_LIB_URL}/${ZOOKEEPER_FILE_NAME} -O "${ZMS_TEM_DIR}/${ZOOKEEPER_FILE_NAME}"
wget ${DOWNLOAD_LIB_URL}/${INFLUXDB_FILE_NAME} -O "${ZMS_TEM_DIR}/${INFLUXDB_FILE_NAME}"
...
if which $PYTHON >/dev/null 2>&1; then
  ...
  wget ${DOWNLOAD_LIB_URL}/${PYTHON_FILE_NAME} -O "${ZMS_TEM_DIR}/${PYTHON_FILE_NAME}"
...
if [ ! -f "$PYTHON_HONE/bin/supervisord" ];then
  ...
  wget ${DOWNLOAD_LIB_URL}/${SUPERVISOR_FILE_NAME} -O "${ZMS_TEM_DIR}/${SUPERVISOR_FILE_NAME}"
...
if ! which unzip >/dev/null 2>&1; then
  wget ${DOWNLOAD_LIB_URL}/${UNZIP_FILE_NAME} -O "${ZMS_TEM_DIR}/${UNZIP_FILE_NAME}"
